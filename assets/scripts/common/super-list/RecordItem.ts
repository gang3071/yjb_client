...
@ccclass('RecordItem')
export class RecordItem extends BaseItem {
    ...
    show(data: any, index: number, callback: Function, layout: SuperLayout) {
        ...
        labShangFen.string = data.open_point
        labXiaFen.string = data.wash_point
        // if (0 <= Number(data.wash_point)) {
        ...
        labWin.string= (Number(data.wash_point) - Number(data.open_point)).toString()
