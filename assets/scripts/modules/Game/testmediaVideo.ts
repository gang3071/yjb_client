...
export class MediaVideo extends Component {
    ...
    setSourcesUrl (ip:string,streamId:string,machineId:number) {
     ...
     */
     private _initializeBrowser(): void {
        ...
        let onCanPlay = () => {
            ...
            if (null == this._video.readyState) {
                return
            }
    ...
    public stop() {
        this._seekTime = 0;
        console.log("==啥意思===",this._isInPlaybackState(),this._currentState)
